...
import com.lzh.community.entity.Event;
import com.lzh.community.entity.Page;
import com.lzh.community.entity.User;
import com.lzh.community.event.EventProducer;
...
public class FollowController implements CommunityConstant {
    ...
    public String getFollowees(@PathVariable("userId") int userId, Page page, Model model){
        ...
        List<Map<String, Object>> userList = followService.findFollowees(userId, page.getOffset(), page.getOffset());
        if (userList != null) {
    ...
    public String getFollowers(@PathVariable("userId") int userId, Page page, Model model){
        ...
        List<Map<String, Object>> userList = followService.findFollowers(userId, page.getOffset(), page.getOffset());
        if (userList != null) {
            for (Map<String, Object> map : userList) {
                User u = (User)map.get("user");
                hasFollowed(u.getId());
